...
- [ ] `System` フィールドを作成した。
- [ ] `Ready` フィールドを作成した。
- [ ] `Ready条件/備考` フィールドを作成した。
- [ ] `Size` フィールドを作成した。
- [ ] `Priority` フィールドを作成した。
- [ ] `Sprint` フィールドを作成した。
- [ ] `Status` フィールドを作成した。
- [ ] 推奨ラベルを作成した。
- [ ] `Product Backlog` ビューを作成した。
- [ ] `Ready Backlog` ビューを作成した。
- [ ] `Refinement` ビューを作成した。
- [ ] `Current Sprint` ビューを作成した。
- [ ] `Sprint Plan` ビューを作成した。
- [ ] `Done by Sprint` ビューを作成した。
- [ ] 既存のPBI候補をIssueとして登録した。
- [ ] 各IssueをProjectへ追加した。
- [ ] 初回スプリント対象のPBIをReadyにした。
